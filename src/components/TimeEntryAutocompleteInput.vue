<template>
  <input ref="input" type="text" v-bind="$attrs" @input="handleInput" />
</template>
...
export default defineComponent({
  name: "TimeEntryAutocompleteInput",
  props: {
    modelValue: {
      ...
      autocompleteInstance = autocomplete<AutocompleteItem>({
        ...
        onSelect(item: AutocompleteItem) {
          ...
          if (item.type === "customer") {
            ...
            modelProxy.value = input.value.value;
