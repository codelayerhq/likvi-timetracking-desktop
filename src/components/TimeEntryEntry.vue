<template>
  <div
    class="flex items-center justify-between h-16 py-2 pl-8 pr-6 space-x-2 bg-gray-100 border-b border-gray-200 cursor-pointer hover:bg-white focus:bg-white focus:outline-none"
    tabindex="2"
